...
public record ProductListResponse(
        ...
        public ProductListResponse(Product product, boolean favorite) {
                this(product.getId(), product.getName(), product.getImage().getStoreFileName(),
                        product.getPrice(), product.getQty(), product.getRemainingQty(),
                        product.getEndDate(), favorite);
        }
}